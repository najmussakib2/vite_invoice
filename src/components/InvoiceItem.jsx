    ...
    <tr>
      <td className="w-[50%]">
        <InvoiceField
          ...
          cellData={{
            className: "p-2 bg-slate-100 my-2 rounded-md",
      ...
      <td className="flex items-center justify-center">
        <button
          className="rounded-md bg-red-500 p-2 text-white shadow-sm transition-colors duration-200 my-2 hover:bg-red-600"
